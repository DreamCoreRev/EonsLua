...
function NavData.Load()
	...
	local Query = WorldDBQuery("SELECT * FROM eons_world.store_categories")
	if(Query) then 
		repeat
...
function CurrencyData.Load()
	...
	local Query = WorldDBQuery("SELECT * FROM eons_world.store_currencies")
	if(Query) then 
		repeat
...
function ServiceData.Load()
	...
	local Query = WorldDBQuery("SELECT * FROM eons_world.store_services;");
	if(Query) then
		repeat
...
function LinkData.Load()
	...
	local Query = WorldDBQuery("SELECT * FROM eons_world.store_category_service_link;");
	if(Query) then
		repeat
