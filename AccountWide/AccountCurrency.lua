...
local function UpdateAccountCurrency(accountId, currencyId, newCount)
    CharDBExecute("INSERT IGNORE INTO accountwide_currency (accountId, currencyId, count) VALUES (" .. accountId .. ", " .. currencyId .. ", " .. newCount .. ") ON DUPLICATE KEY UPDATE count = " .. newCount)
end
